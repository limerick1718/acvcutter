...
invoke-static {p0}, Lokhttp3/CertificatePinner;->sha256(Ljava/security/cert/X509Certificate;)Lyv;
...
throw p0
.end method
.method static sha1(Ljava/security/cert/X509Certificate;)Lyv;
.locals 0
invoke-virtual {p0}, Ljava/security/cert/X509Certificate;->getPublicKey()Ljava/security/PublicKey;
move-result-object p0
invoke-interface {p0}, Ljava/security/PublicKey;->getEncoded()[B
move-result-object p0
invoke-static {p0}, Lyv;->a([B)Lyv;
move-result-object p0
invoke-virtual {p0}, Lyv;->d()Lyv;
move-result-object p0
return-object p0
.end method
.method static sha256(Ljava/security/cert/X509Certificate;)Lyv;
.locals 0
invoke-virtual {p0}, Ljava/security/cert/X509Certificate;->getPublicKey()Ljava/security/PublicKey;
move-result-object p0
invoke-interface {p0}, Ljava/security/PublicKey;->getEncoded()[B
...
if-eqz v10, :cond_3
if-nez v7, :cond_2
invoke-static {v4}, Lokhttp3/CertificatePinner;->sha256(Ljava/security/cert/X509Certificate;)Lyv;
move-result-object v7
:cond_2
iget-object v9, v9, Lokhttp3/CertificatePinner$Pin;->hash:Lyv;
invoke-virtual {v9, v7}, Lyv;->equals(Ljava/lang/Object;)Z
move-result v9
if-eqz v9, :cond_5
return-void
:cond_3
...
if-eqz v10, :cond_6
if-nez v8, :cond_4
invoke-static {v4}, Lokhttp3/CertificatePinner;->sha1(Ljava/security/cert/X509Certificate;)Lyv;
move-result-object v8
:cond_4
iget-object v9, v9, Lokhttp3/CertificatePinner$Pin;->hash:Lyv;
invoke-virtual {v9, v8}, Lyv;->equals(Ljava/lang/Object;)Z
move-result v9
if-eqz v9, :cond_5
return-void
:cond_5
