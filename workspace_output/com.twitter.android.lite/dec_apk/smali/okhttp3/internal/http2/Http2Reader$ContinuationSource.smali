...
iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
return-void
.end method
...
iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
...
iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
invoke-interface {v1}, Lyu;->k()B
move-result v1
and-int/lit16 v1, v1, 0xff
int-to-byte v1, v1
iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
...
if-nez v0, :cond_1
iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
iget-short v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->padding:S
int-to-long v3, v3
invoke-interface {v0, v3, v4}, Lyu;->i(J)V
const/4 v0, 0x0
...
goto :goto_0
:cond_1
iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lyu;
int-to-long v4, v0
invoke-static {p2, p3, v4, v5}, Ljava/lang/Math;->min(JJ)J
move-result-wide p2
invoke-interface {v3, p1, p2, p3}, Lyu;->read(Lys;J)J
move-result-wide p1
cmp-long p3, p1, v1
if-nez p3, :cond_2
return-wide v1
