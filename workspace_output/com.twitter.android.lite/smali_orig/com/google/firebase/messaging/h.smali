...
.field private final c:Lcom/google/firebase/messaging/o;
...
.method final a()Z
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/messaging/o;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v3}, Lcom/google/firebase/messaging/o;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/google/firebase/messaging/n;->a(Ljava/util/concurrent/Executor;)V
    ...
    .line 17
    invoke-static {v3, v4}, Lcom/google/firebase/messaging/f;->a(Landroid/content/Context;Lcom/google/firebase/messaging/o;)Lcom/google/firebase/messaging/e;

    move-result-object v3

    .line 18
    iget-object v4, v3, Lcom/google/firebase/messaging/e;->a:Landroidx/core/app/f$d;
    ...
    .line 19
    :try_start_0
    invoke-virtual {v0}, Lcom/google/firebase/messaging/n;->a()Lgn;
    ...
    invoke-static {v6, v7, v8, v9}, Ljn;->a(Lgn;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {v4, v6}, Landroidx/core/app/f$d;->a(Landroid/graphics/Bitmap;)Landroidx/core/app/f$d;

    .line 21
    new-instance v7, Landroidx/core/app/f$b;

    invoke-direct {v7}, Landroidx/core/app/f$b;-><init>()V

    invoke-virtual {v7, v6}, Landroidx/core/app/f$b;->b(Landroid/graphics/Bitmap;)Landroidx/core/app/f$b;

    const/4 v6, 0x0

    invoke-virtual {v7, v6}, Landroidx/core/app/f$b;->a(Landroid/graphics/Bitmap;)Landroidx/core/app/f$b;

    invoke-virtual {v4, v7}, Landroidx/core/app/f$d;->a(Landroidx/core/app/f$e;)Landroidx/core/app/f$d;
    :try_end_0
    ...
    iget-object v3, v3, Lcom/google/firebase/messaging/e;->a:Landroidx/core/app/f$d;
