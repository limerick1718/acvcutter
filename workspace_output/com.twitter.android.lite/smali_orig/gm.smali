...
.field private final z:Lcom/google/android/gms/common/internal/c;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/c;Landroid/os/Bundle;Lcom/google/android/gms/common/api/f;Lcom/google/android/gms/common/api/g;)V
    ...
    .line 2
    iput-boolean p1, p0, Lgm;->y:Z

    .line 3
    iput-object p4, p0, Lgm;->z:Lcom/google/android/gms/common/internal/c;

    .line 4
    iput-object p5, p0, Lgm;->A:Landroid/os/Bundle;
    ...
    iput-object p1, p0, Lgm;->B:Ljava/lang/Integer;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/c;Lfm;Lcom/google/android/gms/common/api/f;Lcom/google/android/gms/common/api/g;)V
    .locals 8

    .line 6
    invoke-static {p4}, Lgm;->a(Lcom/google/android/gms/common/internal/c;)Landroid/os/Bundle;
    ...
    .line 7
    invoke-direct/range {v0 .. v7}, Lgm;-><init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/c;Landroid/os/Bundle;Lcom/google/android/gms/common/api/f;Lcom/google/android/gms/common/api/g;)V
...
.method public static a(Lcom/google/android/gms/common/internal/c;)Landroid/os/Bundle;
    ...
    .line 11
    invoke-virtual {p0}, Lcom/google/android/gms/common/internal/c;->h()Lfm;
    ...
    .line 18
    invoke-virtual {v0}, Lfm;->e()Ljava/lang/String;
    ...
    .line 22
    invoke-virtual {v0}, Lfm;->c()Ljava/lang/String;
    ...
    .line 25
    invoke-virtual {v0}, Lfm;->b()Ljava/lang/Long;
    ...
    .line 28
    :cond_1
    invoke-virtual {v0}, Lfm;->d()Ljava/lang/Long;
...
.method protected synthetic a(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-direct {v0, p1}, Lnm;-><init>(Landroid/os/IBinder;)V
...
.method public final a(Lkm;)V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lgm;->z:Lcom/google/android/gms/common/internal/c;
    ...
    invoke-static {v1}, Ly4;->a(Landroid/content/Context;)Ly4;

    move-result-object v1

    .line 5
    invoke-virtual {v1}, Ly4;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    iget-object v3, p0, Lgm;->B:Ljava/lang/Integer;
    ...
    invoke-direct {v1, v2}, Lom;-><init>(Lcom/google/android/gms/common/internal/r;)V

    invoke-interface {v0, v1, p1}, Lmm;->a(Lom;Lkm;)V
    :try_end_0
    ...
    invoke-interface {p1, v2}, Lkm;->a(Lqm;)V
    :try_end_1
...
.method protected s()Landroid/os/Bundle;
    ...
    .line 3
    iget-object v0, p0, Lgm;->A:Landroid/os/Bundle;

    iget-object v1, p0, Lgm;->z:Lcom/google/android/gms/common/internal/c;
