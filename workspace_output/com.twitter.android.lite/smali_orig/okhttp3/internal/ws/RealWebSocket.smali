...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Lyv;->b()Ljava/lang/String;
    ...
    .line 156
    new-instance p1, Lokhttp3/internal/ws/-$$Lambda$RealWebSocket$vImgSP5IPT4ir3b3bHxPQ53ps8k;

    invoke-direct {p1, p0}, Lokhttp3/internal/ws/-$$Lambda$RealWebSocket$vImgSP5IPT4ir3b3bHxPQ53ps8k;-><init>(Lokhttp3/internal/ws/RealWebSocket;)V
...
.method private declared-synchronized send(Lyv;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILyv;)V
...
.method checkUpgradeSuccess(Lokhttp3/Response;Lokhttp3/internal/connection/Exchange;)V
    ...
    .line 241
    invoke-virtual {v0}, Lyv;->d()Lyv;

    move-result-object v0

    invoke-virtual {v0}, Lyv;->b()Ljava/lang/String;
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILyv;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lyt;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLyt;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lyu;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLyu;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lyv;)V
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lyv;)V
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lyv;I)Z
...
.method writeOneFrame()Z
    ...
    .line 493
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lyv;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lyv;
    ...
    .line 497
    invoke-virtual {v0, v2, v5, v6}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lzj;
    ...
    .line 499
    invoke-interface {v0, v1}, Lyt;->c(Lyv;)Lyt;
    ...
    iget-object v3, v5, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lyv;

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILyv;)V
...
.method writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lyv;->b:Lyv;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lyv;)V
    :try_end_1
