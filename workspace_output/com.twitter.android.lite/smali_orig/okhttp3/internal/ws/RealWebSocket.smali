...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    .line 11
    invoke-static {p1}, Lhx;->a([B)Lhx;

    move-result-object p1

    invoke-virtual {p1}, Lhx;->f()Ljava/lang/String;
...
.method private declared-synchronized send(Lhx;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILhx;)V
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILhx;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lfx;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLfx;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lgx;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLgx;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lhx;)V
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lhx;)V
...
.method public send(Lhx;)Z
    ...
    .line 3
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lhx;I)Z
...
.method writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lhx;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lhx;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lvx;
    ...
    .line 22
    invoke-interface {v0, v2}, Lfx;->a(Lhx;)Lfx;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lhx;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILhx;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lhx;)V
    :try_end_1
