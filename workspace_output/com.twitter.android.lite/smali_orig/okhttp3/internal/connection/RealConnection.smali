...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lgx;Lfx;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    invoke-interface {v1}, Lwx;->timeout()Lxx;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lxx;->timeout(JLjava/util/concurrent/TimeUnit;)Lxx;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;

    invoke-interface {v1}, Lvx;->timeout()Lxx;
    ...
    .line 17
    :cond_3
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    invoke-interface {p1}, Lgx;->getBuffer()Lex;

    move-result-object p1

    invoke-virtual {p1}, Lex;->m()Z

    move-result p1

    if-eqz p1, :cond_4

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    invoke-interface {v2}, Lgx;->m()Z
...
.method newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lxx;->timeout(JLjava/util/concurrent/TimeUnit;)Lxx;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lxx;->timeout(JLjava/util/concurrent/TimeUnit;)Lxx;
    ...
    invoke-direct {p2, p1, p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lgx;Lfx;)V
...
.method newWebSocketStreams(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v5, p0, Lokhttp3/internal/connection/RealConnection;->source:Lgx;

    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lfx;
    ...
    invoke-direct/range {v2 .. v7}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLgx;Lfx;Lokhttp3/internal/connection/Exchange;)V
