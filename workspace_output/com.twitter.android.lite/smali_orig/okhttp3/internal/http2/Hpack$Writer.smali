...
.method constructor <init>(IZLys;)V
    ...
    .line 404
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lys;
...
.method constructor <init>(Lys;)V
    ...
    .line 397
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLys;)V
...
.method writeByteString(Lyv;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lyv;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Lyv;Lyt;)V
    ...
    .line 557
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lys;
...
.method writeHeaders(Ljava/util/List;)V
    ...
    .line 473
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lyv;

    invoke-virtual {v4}, Lyv;->g()Lyv;

    move-result-object v4

    .line 474
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lyv;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lyv;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lyv;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lyv;
    ...
    .line 512
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lys;

    invoke-virtual {v7, v6}, Lys;->b(I)Lys;

    .line 513
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lyv;)V

    .line 514
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lyv;)V
    ...
    .line 516
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lyv;

    invoke-virtual {v4, v7}, Lyv;->a(Lyv;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lyv;

    invoke-virtual {v7, v4}, Lyv;->equals(Ljava/lang/Object;)Z
...
.method writeInt(III)V
    ...
    .line 534
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lys;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lys;->b(I)Lys;
    ...
    invoke-virtual {v0, p3}, Lys;->b(I)Lys;
    ...
    invoke-virtual {v0, p2}, Lys;->b(I)Lys;
