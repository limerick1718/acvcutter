...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lwx;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lwx;[J)V
    :try_end_0
...
.method writeLengths(Lfx;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Lfx;->writeByte(I)Lfx;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lfx;->f(J)Lfx;
