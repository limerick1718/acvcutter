...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lzk;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lzk;[J)V
    :try_end_0
...
.method writeLengths(Lyt;)V
    ...
    .line 1005
    invoke-interface {p1, v5}, Lyt;->i(I)Lyt;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lyt;->n(J)Lyt;
