...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v6, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v8, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v9, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v10, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v11, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v12, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v13, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    new-array v14, v0, [Lorg/bouncycastle/math/ec/ECCurve$F2m;

    new-instance v24, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v20, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;

    new-instance v15, Ljava/math/BigInteger;

    const-string v0, "5FF6108462A2DC8210AB403925E638A19C1455D21"

    invoke-direct {v15, v0, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v15 .. v23}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    aput-object v24, v14, v4

    new-instance v0, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v28, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;

    new-instance v15, Ljava/math/BigInteger;

    const-string v4, "6EE3CEEB230811759F20518A0930F1A4315A827DAC"

    invoke-direct {v15, v4, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v25 .. v31}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    aput-object v0, v14, v5

    new-instance v0, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v37, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ZERO:Ljava/math/BigInteger;

    new-instance v4, Ljava/math/BigInteger;

    const-string v15, "108576C80499DB2FC16EDDF6853BBB278F6B6FB437D9"

    invoke-direct {v4, v15, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v32 .. v40}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    aput-object v0, v14, v6

    new-instance v0, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v46, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;
    ...
    invoke-direct/range {v41 .. v49}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct/range {v17 .. v23}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    aput-object v0, v14, v8

    new-instance v0, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v30, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;
    ...
    invoke-direct/range {v25 .. v33}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    aput-object v0, v14, v9

    new-instance v0, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v20, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ZERO:Ljava/math/BigInteger;
    ...
    invoke-direct {v13, v12, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v12, Ljava/math/BigInteger;

    const-string v11, "3826F008A8C51D7B95284D9D03FF0E00CE2CD723A"

    invoke-direct {v12, v11, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v15, v13, v12}, Lorg/bouncycastle/math/ec/ECCurve$AbstractF2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v12, v13, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v13, Ljava/math/BigInteger;

    const-string v15, "5F49EB26781C0EC6B8909156D98ED435E45FD59918"

    invoke-direct {v13, v15, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v11, v12, v13}, Lorg/bouncycastle/math/ec/ECCurve$AbstractF2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v11, v12, v3}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {v5, v11, v12}, Lorg/bouncycastle/math/ec/ECCurve$AbstractF2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {v5, v6, v11}, Lorg/bouncycastle/math/ec/ECCurve$AbstractF2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v6, v7, v8, v9, v10}, Lorg/bouncycastle/crypto/params/ECDomainParameters;-><init>(Lorg/bouncycastle/math/ec/ECCurve;Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
