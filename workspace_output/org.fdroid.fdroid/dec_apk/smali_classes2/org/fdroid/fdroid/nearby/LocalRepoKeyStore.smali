...
.field private static final DEFAULT_SIG_ALG:Ljava/lang/String; = "SHA1withRSA"
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .catch Lorg/bouncycastle/operator/OperatorCreationException; {:try_start_3 .. :try_end_3} :catch_3
    ...
    .line 138
    invoke-direct {p0}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore;->generateRandomKeypair()Ljava/security/KeyPair;
    ...
    .line 146
    invoke-direct {p0, p1, v5}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore;->generateSelfSignedCertChain(Ljava/security/KeyPair;Lorg/bouncycastle/asn1/x500/X500Name;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {v0, p1, v2}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore$KerplappKeyManager;-><init>(Ljavax/net/ssl/X509KeyManager;Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore$1;)V
    ...
    .catch Lorg/bouncycastle/operator/OperatorCreationException; {:try_start_5 .. :try_end_5} :catch_3
...
.method private addToStore(Ljava/lang/String;Ljava/security/KeyPair;Ljava/security/cert/Certificate;)V
    ...
    invoke-direct {p2, p1, p3}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore$KerplappKeyManager;-><init>(Ljavax/net/ssl/X509KeyManager;Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore$1;)V
...
.method private generateRandomKeypair()Ljava/security/KeyPair;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/NoSuchAlgorithmException;
...
.method private generateSelfSignedCertChain(Ljava/security/KeyPair;Lorg/bouncycastle/asn1/x500/X500Name;)Ljava/security/cert/Certificate;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;,
    ...
    .line 288
    invoke-direct {p0, p1, p2, v0}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore;->generateSelfSignedCertChain(Ljava/security/KeyPair;Lorg/bouncycastle/asn1/x500/X500Name;Ljava/lang/String;)Ljava/security/cert/Certificate;
...
.method private generateSelfSignedCertChain(Ljava/security/KeyPair;Lorg/bouncycastle/asn1/x500/X500Name;Ljava/lang/String;)Ljava/security/cert/Certificate;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;,
    ...
    invoke-direct {v8, p1}, Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    ...
    invoke-direct {v5, p1, v3}, Lorg/bouncycastle/asn1/x509/Time;-><init>(Ljava/util/Date;Ljava/util/Locale;)V
    ...
    invoke-direct {v6, p1, v2}, Lorg/bouncycastle/asn1/x509/Time;-><init>(Ljava/util/Date;Ljava/util/Locale;)V

    .line 312
    new-instance p1, Lorg/bouncycastle/cert/X509v3CertificateBuilder;
    ...
    .line 321
    new-instance p2, Lorg/bouncycastle/asn1/x509/GeneralNames;

    new-instance v0, Lorg/bouncycastle/asn1/x509/GeneralName;

    const/4 v2, 0x7

    invoke-direct {v0, v2, p3}, Lorg/bouncycastle/asn1/x509/GeneralName;-><init>(ILjava/lang/String;)V

    invoke-direct {p2, v0}, Lorg/bouncycastle/asn1/x509/GeneralNames;-><init>(Lorg/bouncycastle/asn1/x509/GeneralName;)V

    .line 323
    sget-object p3, Lorg/bouncycastle/asn1/x509/X509Extension;->subjectAlternativeName:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    const/4 v0, 0x0

    invoke-virtual {p1, p3, v0, p2}, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->addExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;ZLorg/bouncycastle/asn1/ASN1Encodable;)Lorg/bouncycastle/cert/X509v3CertificateBuilder;

    .line 326
    :cond_0
    invoke-virtual {p1, v1}, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->build(Lorg/bouncycastle/operator/ContentSigner;)Lorg/bouncycastle/cert/X509CertificateHolder;

    move-result-object p1

    .line 327
    new-instance p2, Lorg/bouncycastle/cert/jcajce/JcaX509CertificateConverter;

    invoke-direct {p2}, Lorg/bouncycastle/cert/jcajce/JcaX509CertificateConverter;-><init>()V

    invoke-virtual {p2, p1}, Lorg/bouncycastle/cert/jcajce/JcaX509CertificateConverter;->getCertificate(Lorg/bouncycastle/cert/X509CertificateHolder;)Ljava/security/cert/X509Certificate;
...
.method public setupHTTPSCertificate()V
    ...
    invoke-direct {p0, v0, v1, v2}, Lorg/fdroid/fdroid/nearby/LocalRepoKeyStore;->generateSelfSignedCertChain(Ljava/security/KeyPair;Lorg/bouncycastle/asn1/x500/X500Name;Ljava/lang/String;)Ljava/security/cert/Certificate;
